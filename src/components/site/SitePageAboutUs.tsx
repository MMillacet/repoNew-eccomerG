...
const teamData = [
    {
        ...
        members: [
            ...
            { firstName: 'LEONARDO', lastName: 'De MELLO', role: 'Equipo de Tráfico', team: 'Depto. Logística' },
            { firstName: 'LUIS', lastName: 'TRUCELLI', role: 'Equipo de Logìstica', team: 'Depto. Logística' },
            { firstName: 'RODRIGO', lastName: 'LORENZO', role: 'Equipo de Logìstica', team: 'Depto. Logística' },
            { firstName: 'MATHIAS', lastName: 'MILLACET', role: 'Equipo de Logìstica', team: 'Depto. Logística' },
            { firstName: 'MICHAEL', lastName: 'PORCIÚNCULA', role: 'Equipo de Logìstica', team: 'Depto. Logística' },
            { firstName: 'MARCEL', lastName: 'PUENTE', role: 'Equipo de Tráfico', team: 'Depto. Logística' },
            { firstName: 'FERNANDO', lastName: 'PARADO', role: 'Equipo de Logìstica', team: 'Depto. Logística' },
            { firstName: 'JONATHAN', lastName: 'FERNANDEZ', role: 'Equipo de Logìstica', team: 'Depto. Logística' },
            { firstName: 'FERNANDO', lastName: 'BAIS', role: 'Equipo de Tráfico', team: 'Depto. Logística' },
    ...
    },
    {
        ...
        members: [
            ...
            { firstName: 'ALVARO', lastName: 'CARRIZO', role: 'Vendedor ', team: 'Depto Comercial' },
            { firstName: 'ALEJANDRO', lastName: 'TRIBEL', role: 'Vendedor ', team: 'Depto Comercial' },
            { firstName: 'GONZALO', lastName: 'MISA', role: 'Vendedor ', team: 'Depto Comercial' },
        ],
    },
    {
        name: 'Gerencia Gral.',
        members: [{ firstName: 'SYLVINA', lastName: 'BLUTH', role: 'Gerente General ', team: 'Gerencia Gral.' }],
    },
    {
